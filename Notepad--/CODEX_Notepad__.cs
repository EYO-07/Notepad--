...
//		fold_all(editor);
    ...
    public static void set_javascript_style(Scintilla scintilla) {
        set_c_family_style(scintilla);
        // JavaScript keywords
        scintilla.SetKeywords(0,"break case catch class const continue debugger default delete do else export extends finally for function if import in instanceof let new return super switch this throw try typeof var void while with yield");
        // Built-in objects / common globals
        scintilla.SetKeywords(1,"Array Boolean Date Error Function JSON Math Number Object Promise RegExp String Map Set WeakMap WeakSet Symbol BigInt console window document");
    }
    public static void set_lua_style(Scintilla scintilla) { // REVISION
        // Default
    ...
    public static void set_html_style(Scintilla scintilla) { // REVISION
        // Default
...
//        scintilla.Styles[Style.Html.Operator].ForeColor = Color.Yellow;
    ...
    public static void set_powershell_style(Scintilla scintilla) { // REVISION
        // Default
    ...
    public static void set_c_family_style(Scintilla scintilla) { // REVISION
...
//        scintilla.SetKeywords(3, "const static partial false true null");
    ...
    public static void set_bat_style(Scintilla scintilla) {
        ...
        // Bash keywords
        scintilla.SetKeywords(0,
            "taskkill sfc ipconfig netsh start REM if then else elif fi for while do done case esac function select in time until");
